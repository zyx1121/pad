;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
          ...
          (this.handlePotentialScroll = () => {
            ...
            if (e.apply) {
              ...
              if (
                ...
                r ||
                  (r = "u" < typeof window ? null : (0, _.findDOMNode)(this)),
  ...
  (e, t, r) => {
    ...
    let n = e.r(54106).createRenderSearchParamsFromClient
    ;("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let n = e.r(66093).createRenderParamsFromClient
    ;("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
              ...
              get(e, t, r) {
                ...
                if ("string" == typeof t && "then" === t) {
                  ...
                  l.dynamicShouldError
                    ? (0,
                      f.throwWithStaticGenerationBailoutErrorWithDynamicError)(
                        l.route,
                        e
                      )
                      ...
                      l.wellKnownProperties.has(e) ||
                        (t.has(e) &&
                          Object.defineProperty(o, e, {
                            get() {
                              let t = (0, l.describeStringPropertyAccess)(
                                "params",
                                e
                              )
    ...
    function u({ Component: t, serverProvidedParams: r }) {
      ...
      if (null !== r) ((u = r.searchParams), (l = r.params))
        ...
        ;((l = null !== e ? e.parentParams : {}),
          (u = (0, s.urlSearchParamsToParsedUrlQuery)(
            (0, i.use)(c.SearchParamsContext)
          )))
      }
      if ("u" < typeof window) {
        let r,
          o,
          { workAsyncStorage: i } = e.r(43831),
          s = i.getStore()
        if (!s)
          throw Object.defineProperty(
        ...
        let { createSearchParamsFromClient: c } = e.r(43384)
        r = c(u, s)
        let { createParamsFromClient: d } = e.r(89008)
        return ((o = d(l, s)), (0, n.jsx)(t, { params: o, searchParams: r }))
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(64775),
          a = r(u),
          { createRenderParamsFromClient: o } = e.r(15022),
          i = o(l)
  ...
  (e, t, r) => {
    ...
    function s({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ("u" < typeof window) {
        ...
        let { createParamsFromClient: u } = e.r(89008)
        return ((o = u(c, s)), (0, n.jsx)(t, { ...r, params: o }))
      }
      {
        let { createRenderParamsFromClient: a } = e.r(15022),
          o = a(c)
