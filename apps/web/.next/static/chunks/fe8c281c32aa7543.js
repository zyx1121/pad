;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    t.exports = function (e, t) {
      ...
      function d() {
        ...
        return function (t) {
          return ((t.position = new h(e)), g(l), t)
        }
      }
      function h(e) {
        ;((this.start = e),
      ...
      for (
        ...
        (k = (function () {
          var e = d(),
            t = g(o)
          if (t) {
            if ((x(), !g(a))) return m("property missing ':'")
            var n = g(u),
              i = e({
                type: "declaration",
                property: f(t[0].replace(r, "")),
                value: n ? f(n[0].replace(r, "")) : "",
              })
            return (g(s), i)
          }
        })());
  ...
  (e, t, n) => {
    ...
    n.camelCase = function (e, t) {
      var n
      return (void 0 === t && (t = {}), !(n = e) || l.test(n) || r.test(n))
        ? e
        : ((e = e.toLowerCase()),
          (e = t.reactCompat ? e.replace(a, s) : e.replace(o, s)).replace(i, u))
    }
  },
  39842,
  (e, t, n) => {
  ...
  (e) => {
    ...
    function M(e) {
      ...
      for (let [r, i] of Object.entries(e.properties)) {
        let l = new w(r, e.transform(e.attributes || {}, r), i, e.space)
        ;(e.mustUseProperty &&
    ...
    let R = M({
        ...
        properties: {
          ...
          shadowRootCustomElementRegistry: p,
          shadowRootDelegatesFocus: p,
          shadowRootMode: null,
          shadowRootSerializable: p,
          shape: null,
          size: m,
          sizes: null,
          slot: null,
    ...
    class J extends Error {
      constructor(e, t, n) {
        ...
        ;((this.ancestors = i.ancestors || void 0),
          ...
          (this.stack =
            l && i.cause && "string" == typeof i.cause.stack
              ? i.cause.stack
              : ""),
          (this.actual = void 0),
    ...
    function ei(e, t, r) {
      var i, l, o, a, u, f, p, d, h
      let m, g, y, x, k, v, b, P, I, M, F
        ...
        ? ((i = e),
          ...
          et.has(l.tagName) &&
            (k = k.filter(function (e) {
              return (
                "string" != typeof e ||
                !("object" == typeof e ? "text" === e.type && s(e.value) : s(e))
              )
            })),
          el(i, x, y, l),
          eo(x, k),
        ...
        : "mdxFlowExpression" === t.type || "mdxTextExpression" === t.type
          ...
          : "mdxJsxFlowElement" === t.type || "mdxJsxTextElement" === t.type
            ? ((a = e),
              ...
              (f = r),
              (b = v = a.schema),
              "svg" === u.name && "html" === v.space && (a.schema = H),
              a.ancestors.push(u),
              (P = null === u.name ? a.Fragment : eu(a, u.name, !0)),
              (I = (function (e, t) {
                let r = {}
                for (let i of t.attributes)
                  if ("mdxJsxExpressionAttribute" === i.type)
                    if (i.data && i.data.estree && e.evaluater) {
                      ...
                      n("ExpressionStatement" === t.type)
                      let l = t.expression
                      n("ObjectExpression" === l.type)
                      let o = l.properties[0]
                      ;(n("SpreadElement" === o.type),
                        Object.assign(
                          r,
    ...
    function eu(e, t, r) {
      ...
      if (r)
        if (t.includes(".")) {
          ...
          for (; ++l < r.length;) {
            let t = a(r[l])
              ? { type: "Identifier", name: r[l] }
              : { type: "Literal", value: r[l] }
            e = e
              ? {
        ...
        tokenize: function (e) {
          ...
          function u(e) {
            if ((o++, i.containerState._closeFlow)) {
              ...
              return (
                eg(i.events, l + 1, 0, i.events.slice(r)),
                (i.events.length = a),
                s(e)
              )
            }
          ...
          function s(n) {
            ...
            return ((i.containerState = {}), e.check(eR, c, f)(n))
          }
          function c(e) {
            return (t && y(), g(o), p(e))
          }
          ...
          function p(t) {
            return ((i.containerState = {}), e.attempt(eR, d, h)(t))
          }
          function d(e) {
          ...
          function m(e, l) {
            ...
            if (
              ...
              ;(eg(i.events, u + 1, 0, i.events.slice(a)),
                (i.events.length = l))
            }
          }
          function g(t) {
    ...
    class eN {
      ...
      splice(e, t, n) {
        ...
        return (n && e_(this.left, n), r.reverse())
      }
      pop() {
      ...
      pushMany(e) {
        ;(this.setCursor(1 / 0), e_(this.left, e))
      }
      unshift(e) {
        ;(this.setCursor(0), this.right.push(e))
      }
      unshiftMany(e) {
        ;(this.setCursor(0), e_(this.right, e.reverse()))
      }
      setCursor(e) {
        if (
          e !== this.left.length &&
      ...
      for (; ++s < c.length;) {
        ...
        if ("enter" === t[0])
            ...
            (Object.assign(
              ...
              (function (e, t) {
                let n,
                  ...
                  u = i._tokenizer
                !u &&
                  ((u = l.parser[i.contentType](i.start)),
                  i._contentTypeTextTrailing &&
                    (u._contentTypeTextTrailing = !0))
                let s = u.events,
                  c = [],
                  f = {},
                  p = -1,
                ...
                for (c.reverse(), p = -1; ++p < c.length;)
                  ((f[h + c[p][0]] = h + c[p][1]), (h += c[p][1] - c[p][0] - 1))
                return f
              })(c, s)
            ),
            (s = u[s]),
          ...
          n &&
            ...
            (l = c.slice(n, s)).unshift(t),
            c.splice(n, s - n + 1, l))
        }
      }
      return (eg(e, 0, 1 / 0, c.slice(0)), !a)
    }
    let eU = {
        resolve: function (e) {
          return (eB(e), e)
          ...
          let t = this,
            n = e.attempt(
              ...
              e.attempt(
                ...
                eF(
                  e,
                  e.attempt(this.parser.constructs.flow, r, e.attempt(eU, r)),
                  "linePrefix"
                )
              )
            )
    ...
    function eK(e) {
      return {
        resolveAll: eQ("text" === e ? eZ : void 0),
        tokenize: function (t) {
          let n = this,
          ...
          if ((t._contentTypeTextTrailing && n === e.length && (u = 0), u)) {
            ...
            ;((i.end = { ...l.start }),
              i.start.offset === i.end.offset
                ? Object.assign(i, l)
                : (e.splice(n, 0, ["enter", l, t], ["exit", l, t]), (n += 2)))
          }
          n++
        }
      return e
    ...
    function eX(e) {
      return null === e || eD(e) || eI(e) ? 1 : eP(e) ? 2 : void 0
    }
    function eJ(e, t, n) {
      let r = [],
        i = -1
    ...
    let e3 = {
          ...
          function a(t) {
            return 35 === t
              ? (e.enter("characterReferenceMarkerNumeric"),
                ...
                u)
              : (e.enter("characterReferenceValue"), (r = 31), (i = eb), s(t))
          }
          function u(t) {
            return 88 === t || 120 === t
              ? (e.enter("characterReferenceMarkerHexadecimal"),
                ...
                (i = eE),
                s)
              : (e.enter("characterReferenceValue"), (r = 7), (i = eC), s(t))
          }
          function s(a) {
            if (59 === a && o) {
              let r = e.exit("characterReferenceValue")
              return i !== eb || e4(l.sliceSerialize(r))
                ? (e.enter("characterReferenceMarker"),
                  e.consume(a),
                  e.exit("characterReferenceMarker"),
      ...
      e5 = {
        ...
        tokenize: function (e, t, n) {
          ...
          function u(l) {
            return null === l || eT(l)
              ? (e.exit("codeFencedFence"),
                i.interrupt ? t(l) : e.check(e9, c, h)(l))
          ...
          function p(t) {
            return o > 0 && eL(t) ? eF(e, d, "linePrefix", o + 1)(t) : d(t)
          }
          function d(t) {
            return null === t || eT(t)
              ? e.check(e9, c, h)(t)
    ...
    function e8(e, t, n, r, i, l, o, a, u) {
      let s = u || 1 / 0,
        c = 0
      return function (t) {
        return 60 === t
          ? (e.enter(r), e.enter(i), e.enter(l), e.consume(t), e.exit(l), f)
          : null === t || 32 === t || 41 === t || eS(t)
            ? n(t)
            : (e.enter(r),
              e.enter(o),
              e.enter(a),
      ...
      function f(n) {
        return 62 === n
          ? (e.enter(l), e.consume(n), e.exit(l), e.exit(i), e.exit(r), t)
          : (e.enter(a),
            e.enter("chunkString", { contentType: "string" }),
            p(n))
      }
      ...
      return function r(i) {
        return eT(i)
          ? (e.enter("lineEnding"),
            ...
            r)
          : eL(i)
            ? eF(e, r, n ? "linePrefix" : "lineSuffix")(i)
            : t(i)
      }
    }
    function tr(e) {
    ...
    let ti = {
        ...
        tokenize: function (e, t, n) {
          ...
          function i(t) {
            return eL(t) ? eF(e, l, "whitespace")(t) : l(t)
          }
          function l(e) {
            return null === e || eT(e) ? t(e) : n(e)
          }
      ...
      ts = {
        ...
        resolveTo: function (e, t) {
          ...
          return (
            ...
            (l = ey(l, [["exit", c, t], e[i - 2], e[i - 1], ["exit", s, t]])),
            (l = ey(l, e.slice(i + 1))),
            (l = ey(l, [["exit", u, t]])),
            eg(e, r, e.length, l),
            e
        ...
        tokenize: function (e, t, n) {
            ...
            return r
              ? r._inactive
                ...
                : ((i = l.parser.defined.includes(
                    tr(l.sliceSerialize({ start: r.end, end: l.now() }))
                  )),
                  e.enter("labelEnd"),
                  e.enter("labelMarker"),
                  e.consume(t),
          ...
          function a(t) {
            return 40 === t
              ? e.attempt(tc, s, i ? s : c)(t)
              : 91 === t
                ? e.attempt(tf, s, i ? u : c)(t)
                : i
                  ? s(t)
                  : c(t)
          }
          function u(t) {
            return e.attempt(tp, s, c)(t)
          }
          function s(e) {
            return t(e)
          }
              ...
              e.check(
                ...
                function (n) {
                  return (
                    ...
                    eF(e, t, "listItemIndent", r.containerState.size + 1)(n)
                  )
                },
                function (n) {
        ...
        tokenize: function (e, t, n) {
            ...
            if (
              ...
              if (
                ...
                return (
                  ...
                  42 === t || 45 === t ? e.check(tg, n, a)(t) : a(t)
                )
              if (!r.interrupt || 49 === t)
                return (
                  e.enter("listItemPrefix"),
          ...
          function a(t) {
            return (
              ...
              e.check(ej, r.interrupt ? n : u, e.attempt(tx, c, s))
            )
          }
          function u(e) {
        ...
        0,
        {
          91: {
            ...
            tokenize: function (e, t, n) {
              ...
              function c(l) {
                return null === l || eT(l)
                  ? (e.exit("definition"), i.parser.defined.push(r), t(l))
                  : n(l)
              }
            },
          },
        ...
        0,
        {
          ...
          60: {
            ...
            tokenize: function (e, t, n) {
              ...
              function s(o) {
                return 33 === o
                  ...
                  : 47 === o
                    ? (e.consume(o), (i = !0), d)
                    : 63 === o
                      ? (e.consume(o), (r = 3), u.interrupt ? t : M)
                      : ev(o)
                        ? (e.consume(o), (l = String.fromCharCode(o)), h)
                        : n(o)
              }
              function c(i) {
                return 45 === i
                  ...
                  : 91 === i
                    ...
                    : ev(i)
                      ? (e.consume(i), (r = 4), u.interrupt ? t : M)
                      : n(i)
              }
              function f(r) {
                return 45 === r ? (e.consume(r), u.interrupt ? t : M) : n(r)
              }
              function p(r) {
                let i = "CDATA["
              ...
              function d(t) {
                return ev(t)
                  ? (e.consume(t), (l = String.fromCharCode(t)), h)
                  : n(t)
              }
              function h(o) {
                if (null === o || 47 === o || 62 === o || eD(o)) {
                  let a = 47 === o,
                    s = l.toLowerCase()
                  return !a && !i && to.includes(s)
                    ? ((r = 1), u.interrupt ? t(o) : C(o))
                    : tl.includes(l.toLowerCase())
                      ? ((r = 6), a)
                        ? (e.consume(o), m)
                        : u.interrupt
                          ? t(o)
              ...
              function y(t) {
                return 45 === t || 46 === t || 58 === t || 95 === t || eb(t)
                  ? (e.consume(t), y)
                  : x(t)
              }
              function x(t) {
                    ...
                    : 62 === t && 4 === r
                      ...
                      : 63 === t && 3 === r
                        ...
                        : 93 === t && 5 === r
                          ? (e.consume(t), I)
                          : eT(t) && (6 === r || 7 === r)
                            ? (e.exit("htmlFlowData"), e.check(ta, z, E)(t))
                            : null === t || eT(t)
                              ? (e.exit("htmlFlowData"), E(t))
                              : (e.consume(t), C)
              }
              function E(t) {
                return e.check(tu, A, z)(t)
              }
              function A(t) {
                return (
                  e.enter("lineEnding"),
              ...
              function D(t) {
                return 45 === t ? (e.consume(t), M) : C(t)
              }
              function L(t) {
                return 47 === t ? (e.consume(t), (l = ""), P) : C(t)
              }
              function P(t) {
                if (62 === t) {
                  let n = l.toLowerCase()
                  return to.includes(n) ? (e.consume(t), F) : C(t)
                }
                return ev(t) && l.length < 8
                  ? (e.consume(t), (l += String.fromCharCode(t)), P)
                  : C(t)
              }
              function I(t) {
                return 93 === t ? (e.consume(t), M) : C(t)
              }
              function M(t) {
                return 62 === t
                  ? (e.consume(t), F)
          ...
          60: [
            {
              ...
              tokenize: function (e, t, n) {
                ...
                function i(t) {
                  return ev(t) ? (e.consume(t), l) : 64 === t ? n(t) : a(t)
                }
                function l(t) {
                  return 43 === t || 45 === t || 46 === t || eb(t)
                    ? ((r = 1),
                      (function t(n) {
                        return 58 === n
                          ? (e.consume(n), (r = 0), o)
    ...
    let tC = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi
    function tE(e, t, n) {
      if (t) return t
      if (35 === n.charCodeAt(0)) {
        let e = n.charCodeAt(1),
          t = 120 === e || 88 === e
        return tS(n.slice(t ? 2 : 1), t ? 16 : 10)
      }
      return e4(n) || e
    }
          ...
          (function (e) {
            let t = {
              ...
              exit: {
                ...
                characterReference: function (e) {
                  this.stack.pop().position.end = tT(e.end)
                },
                ...
                definitionLabelString: function (e) {
                  ...
                  ;((n.label = t),
                    (n.identifier = tr(this.sliceSerialize(e)).toLowerCase()))
                },
                ...
                labelText: function (e) {
                  ...
                  ;((n.label = t.replace(tC, tE)),
                    (n.identifier = tr(t).toLowerCase()))
                },
                lineEnding: function (e) {
                  let n = this.stack[this.stack.length - 1]
                  if (this.data.atHardBreak) {
                    ;((n.children[n.children.length - 1].position.end = tT(
                      e.end
                    )),
            ...
            function l(e, t, n) {
              ;(this.stack[this.stack.length - 1].children.push(e),
                ...
                (e.position = { start: tT(t.start), end: void 0 }))
            }
            function o(e) {
              return function (t) {
                  ...
                  function (e, t, n) {
                    ...
                    for (
                      e =
                        ...
                        s = 0,
                        a = "",
                        u && (65279 === e.charCodeAt(0) && s++, (u = void 0));
                      s < e.length;
                    ) {
                      if (
                        ((tw.lastIndex = s),
                        (c =
                          (r = tw.exec(e)) && void 0 !== r.index
                            ? r.index
                            : e.length),
                        (f = e.charCodeAt(c)),
                        !r)
                      ...
                      if (10 === f && s === c && l) (p.push(-3), (l = void 0))
                        ...
                        switch (
                          ...
                          case 0:
                            ...
                            break
                          case 9:
                            for (i = 4 * Math.ceil(o / 4), p.push(-2); o++ < i;)
                              p.push(-1)
                            break
                          case 10:
                            ;(p.push(-4), (o = 1))
                    ...
                    return (
                      n && (l && p.push(-5), a && p.push(a), p.push(null)),
                      p
                    )
                  })(n, r, !0)
                )
    ...
    let tP = "object" == typeof self ? self : globalThis,
      tI = (e, t) => {
        switch (e) {
          case "Function":
          case "SharedWorker":
      ...
      tR = ([e, t]) => 0 === e && ("function" === t || "symbol" === t),
      tj = (e, { json: t, lossy: n } = {}) => {
        var r, i, l
        let o,
          a,
            ...
            switch (t) {
              ...
              case 2: {
                ...
                let l = [],
                  u = o([t, l], e)
                for (let t of tz(e))
                  (r || !tR(tO(e[t]))) && l.push([a(t), a(e[t])])
                return u
              }
              case 3:
                return o([t, isNaN(e.getTime()) ? "" : e.toISOString()], e)
              case 4: {
              ...
              case 5: {
                let n = [],
                  i = o([t, n], e)
                for (let [t, i] of e)
                  (r || !(tR(tO(t)) || tR(tO(i)))) && n.push([a(t), a(i)])
                return i
              }
              case 6: {
                let n = [],
                  i = o([t, n], e)
                for (let t of e) (r || !tR(tO(t))) && n.push(a(t))
                return i
              }
            }
            let { message: u } = e
            return o([t, { name: n, message: u }], e)
          }))(e),
          u
        )
      },
    ...
    function t_(e) {
      ...
      for (; ++n < e.length;) {
        let l = e.charCodeAt(n),
          o = ""
        if (37 === l && eb(e.charCodeAt(n + 1)) && eb(e.charCodeAt(n + 2)))
          i = 2
        else if (l < 128)
    ...
    let tH = function (e) {
      var t, n
      if (null == e) return tq
      if ("function" == typeof e) return tV(e)
      if ("object" == typeof e) {
        return Array.isArray(e)
          ? (function (e) {
              let t = [],
                n = -1
              for (; ++n < e.length;) t[n] = tH(e[n])
      ...
      ;(function e(i, a, u) {
        ...
        function c() {
          ...
          let c,
            ...
            d = tW
          if (
            (!t || l(i, a, u[u.length - 1] || void 0)) &&
            !1 ===
              (d = Array.isArray((s = n(i, u)))
                ? s
                : "number" == typeof s
                  ? [!0, s]
                  : null == s
          ...
          if ("children" in i && i.children && i.children && "skip" !== d[0])
            for (
              f = (r ? i.children.length : -1) + o, p = u.concat(i);
              f > -1 && f < i.children.length;
            ) {
              if (!1 === (c = e(i.children[f], f, p)())[0]) return c
    ...
    let tJ = {
      ...
      table: function (e, t) {
        ...
        if (n.length > 0) {
          let r = {
            ...
            l = W(t.children[1]),
            o = q(t.children[t.children.length - 1])
      ...
      tableRow: function (e, t, n) {
        let r = n ? n.children : void 0,
          ...
          o = l ? l.length : t.children.length,
          a = -1,
          u = []
        for (; ++a < o;) {
          let n = t.children[a],
            ...
            o = l ? l[a] : void 0
          o && (r.align = o)
          let s = { type: "element", tagName: i, properties: r, children: [] }
          ;(n &&
        ...
        let n = {
          ...
          value: (function (e) {
            let t = String(e),
              ...
              l = []
            for (; r;)
              (l.push(tX(t.slice(i, r.index), i > 0, !0), r[0]),
                (i = r.index + r[0].length),
                (r = n.exec(t)))
            return (l.push(tX(t.slice(i), i > 0, !1)), l.join(""))
          })(String(t.value)),
        }
        return (e.patch(t, n), e.applyData(t, n))
      },
      ...
      let r,
        ...
        a =
          ...
          (o = {
                ...
                for (; ++r < n.length;) {
                  ...
                  if (i) {
                    if (
                      ...
                      let e = i.children[0]
                      e && "text" === e.type && (e.value = t3(e.value))
                    }
            ...
            footnoteOrder: [],
            handlers: { ...tJ, ...r.handlers },
            one: function (e, t) {
              let n = e.type,
                r = o.handlers[n]
              if (tG.call(o.handlers, n) && r) return r(o, e, t)
        ...
        s = (function (e) {
          let t =
              "string" == typeof e.options.clobberPrefix
                ? e.options.clobberPrefix
                : "user-content-",
            n = e.options.footnoteBackContent || tB,
            r = e.options.footnoteBackLabel || tU,
    ...
    let ne = function (e, t) {
        ...
        for (; l--;)
          if (47 === e.codePointAt(l)) {
            ...
            (o < 0 && ((n = !0), (o = l + 1)),
              a > -1 &&
                (e.codePointAt(l) === t.codePointAt(a--)
                  ? a < 0 && (i = l)
                  : ((a = -1), (i = o))))
      ...
      nr = function (...e) {
        ...
        let n,
          ...
          l = -1
        for (; ++l < e.length;)
          (ni(e[l]), e[l] && (i = void 0 === i ? e[l] : i + "/" + e[l]))
        return void 0 === i
          ? "."
          : (ni((t = i)),
    ...
    let no = ["history", "path", "basename", "stem", "extname", "dirname"]
    class na {
      constructor(e) {
        let t, n
        ;((t = e
        ...
        for (n in t) no.includes(n) || (this[n] = t[n])
      }
      get basename() {
        return "string" == typeof this.path ? ne(this.path) : void 0
      }
      set basename(e) {
        ;(ns(e, "basename"),
          nu(e, "basename"),
          (this.path = nr(this.dirname || "", e)))
      }
      get dirname() {
        return "string" == typeof this.path ? nt(this.path) : void 0
      }
      set dirname(e) {
        ;(nc(this.basename, "dirname"),
          (this.path = nr(e || "", this.basename)))
      }
      get extname() {
        return "string" == typeof this.path ? nn(this.path) : void 0
      }
      set extname(e) {
        if ((nu(e, "extname"), nc(this.dirname, "extname"), e)) {
          if (46 !== e.codePointAt(0))
            throw Error("`extname` must start with `.`")
          if (e.includes(".", 1))
            throw Error("`extname` cannot contain multiple dots")
        }
        this.path = nr(this.dirname, this.stem + (e || ""))
      }
      get path() {
      ...
      get stem() {
        return "string" == typeof this.path
          ? ne(this.path, this.extname)
          : void 0
      }
      set stem(e) {
        ;(ns(e, "stem"),
          nu(e, "stem"),
          (this.path = nr(this.dirname || "", e + (this.extname || ""))))
      }
      fail(e, t, n) {
    ...
    class nd extends nf {
                      ...
                      a
                        ? (function (e, t) {
                            ...
                            return function (...t) {
                              ...
                              o ||
                                (l && l.then && "function" == typeof l.then
                                  ? l.then(i, r)
                                  : l instanceof Error
                                    ? r(l)
                                    : i(l))
      ...
      copy() {
        ...
        return (e.data((0, t7.default)(!0, {}, this.namespace)), e)
      }
      data(e, t) {
        return "string" == typeof e
          ? 2 == arguments.length
            ? (ny("data", this.frozen), (this.namespace[e] = t), this)
            : (np.call(this.namespace, e) && this.namespace[e]) || void 0
          : e
            ? (ny("data", this.frozen), (this.namespace = e), this)
            : this.namespace
      }
      freeze() {
      ...
      parse(e) {
        ...
        return (nm("parse", n), n(String(t), t))
      }
      process(e, t) {
        let r = this
        return (
          this.freeze(),
          nm("process", this.parser || this.Parser),
          ng("process", this.compiler || this.Compiler),
        ...
        function i(i, l) {
          ...
          function u(e, r) {
            e || !r
              ...
              : i
                ? i(r)
                : (n(t, "`done` is defined if `resolve` is not"), t(void 0, r))
          }
          r.run(a, o, function (e, t, n) {
            var i, l
            if (e || !t || !n) return u(e)
            let o = r.stringify(t, n)
            ;("string" == typeof (i = o) ||
            ((l = i) &&
              "object" == typeof l &&
              "byteLength" in l &&
      ...
      processSync(e) {
        ...
        return (
          this.freeze(),
          nm("processSync", this.parser || this.Parser),
          ng("processSync", this.compiler || this.Compiler),
          this.process(e, function (e, n) {
            ;((r = !0), t6(e), (t = n))
          }),
          nk("processSync", "process", r),
          n(t, "we either bailed on an error or have a tree"),
          t
        )
      }
      run(e, t, r) {
        ...
        function l(l, o) {
          ...
          let a = nv(t)
          i.run(e, a, function (t, i, a) {
            let u = i || e
            t
              ? o(t)
              : l
                ? l(u)
                : (n(r, "`done` is defined if `resolve` is not"),
                  r(void 0, u, a))
          })
        }
      }
      runSync(e, t) {
        ...
        return (
          ...
          nk("runSync", "run", i),
          n(r, "we either bailed on an error or have a tree"),
          r
        )
      }
      stringify(e, t) {
        ...
        return (ng("stringify", r), nx(e), r(e, n))
      }
      use(e, ...t) {
        let n = this.attachers,
          r = this.namespace
        if ((ny("use", this.frozen), null == e));
        else if ("function" == typeof e) o(e, t)
        else if ("object" == typeof e) Array.isArray(e) ? l(e) : i(e)
        ...
        function i(e) {
          ...
          ;(l(e.plugins),
            e.settings &&
              (r.settings = (0, t7.default)(!0, r.settings, e.settings)))
        }
        function l(e) {
          let t = -1
          if (null == e);
        ...
        function o(e, t) {
          ...
          if (-1 === i) n.push([e, ...t])
            ...
            let [r, ...l] = t,
              o = n[i][1]
            ;(t8(o) && t8(r) && (r = (0, t7.default)(!0, o, r)),
              (n[i] = [e, r, ...l]))
          }
        }
      }
    }
    let nh = new nd().freeze()
    function nm(e, t) {
    ...
    let nb = [],
      nw = { allowDangerousHtml: !0 },
      nS = /^(https?|ircs?|mailto|xmpp)$/i,
      nC = [
    ...
    function nE(e) {
      ...
      let i,
        ...
        u,
        s =
          ((i = (n = e).rehypePlugins || nb),
          (l = n.remarkPlugins || nb),
          (o = n.remarkRehypeOptions
            ? { ...n.remarkRehypeOptions, ...nw }
            : nw),
          nh().use(tL).use(l).use(t5, o).use(i)),
        c =
          ((a = e.children || ""),
          (u = new na()),
          "string" == typeof a
      ...
      return (function (e, n) {
        ...
        return (
          ...
          tK(e, function (e, t, n) {
            if ("raw" === e.type && n && "number" == typeof t)
              return (
                u
                  ...
                  : (n.children[t] = { type: "text", value: e.value }),
                t
              )
            if ("element" === e.type) {
              let t
            ...
            if ("element" === e.type) {
              let r = i ? !i.includes(e.tagName) : !!a && a.includes(e.tagName)
              if (
                (!r && l && "number" == typeof t && (r = !l(e, t, n)),
                r && n && "number" == typeof t)
              )
                return (
                  s && e.children
          ...
          (function (e, t) {
            ...
            return s && "string" != typeof s
              ? s
              : u.create(e, u.Fragment, { children: s || void 0 }, void 0)
          })(e, {
            Fragment: t.Fragment,
            components: o,
    ...
    function nF(e) {
      ...
      let t = this.stack[this.stack.length - 1]
      ;(n("link" === t.type), (t.url = "http://" + this.sliceSerialize(e)))
    }
    function nz(e) {
                ...
                if (
                  ...
                  !1 === l
                    ...
                    : (a !== n &&
                      ...
                      Array.isArray(l) ? c.push(...l) : l && c.push(l),
                      (a = n + f[0].length),
                      (s = !0)),
                  !r.global)
                )
    ...
    function n_(e, t) {
      ...
      return (0 === e.index || eI(n) || eP(n)) && (!t || 47 !== n)
    }
    function nB() {
      this.buffer()
    }
    ...
    function nq(e) {
      ...
      ;(n("footnoteReference" === r.type),
        (r.identifier = tr(this.sliceSerialize(e)).toLowerCase()),
        (r.label = t))
    }
    function nW(e) {
      this.exit(e)
    ...
    let n3 = function (e, t, n, r) {
      ...
      let u = n.enter("listItem"),
        s = n.indentLines(n.containerFlow(e, a.current()), function (e, t, n) {
          return t
            ? (n ? "" : " ".repeat(o)) + e
    ...
    function re(e) {
      let t = this.resume()
      this.data.inTable && (t = t.replace(/\\([\\|])/g, rt))
      let r = this.stack[this.stack.length - 1]
      ;(n("inlineCode" === r.type), (r.value = t), this.exit(e))
    }
    function rt(e, t) {
      return "|" === t ? t : e
    }
        ...
        if (r && "text" === r.type) {
          ...
          n === e &&
            ...
            0 === r.value.length
              ...
              : e.position &&
                r.position &&
                "number" == typeof r.position.start.offset &&
    ...
    let rl = {
      ...
      ro = {
        tokenize: function (e, t, n) {
          ...
          function o(t) {
            return 46 === t || 95 === t
              ? e.check(ru, u, a)(t)
              : null === t || eD(t) || eI(t) || (45 !== t && eP(t))
                ? u(t)
                : ((l = !0), e.consume(t), o)
          }
          function a(t) {
            return (
              95 === t ? (r = !0) : ((i = r), (r = void 0)),
              e.consume(t),
              o
            )
          }
          ...
          function r(o) {
            return 33 === o ||
              ...
              : 38 === o
                ...
                : 93 === o
                  ? (e.consume(o), i)
                  : 60 === o || null === o || eD(o) || eI(o)
                    ? t(o)
                    : n(o)
          }
          function i(e) {
            return null === e || 40 === e || 91 === e || eD(e) || eI(e)
              ? t(e)
              : r(e)
          }
          function l(t) {
      ...
      rc = {
        ...
        tokenize: function (e, t, n) {
          ...
          return function (t) {
            return (87 !== t && 119 !== t) ||
              !rm.call(r, r.previous) ||
              rk(r.events)
              ? n(t)
              : (e.enter("literalAutolink"),
                e.enter("literalAutolinkWww"),
                e.check(rl, e.attempt(ro, e.attempt(ra, i), n), n)(t))
          }
          function i(n) {
            return (
      ...
      rf = {
        ...
        tokenize: function (e, t, n) {
          ...
          function u(t) {
            return null === t || eS(t) || eD(t) || eI(t) || eP(t)
              ? n(t)
      ...
      rp = {
        ...
        tokenize: function (e, t, n) {
          let r,
            ...
            l = this
          return function (t) {
            return !rx(t) || !ry.call(l, l.previous) || rk(l.events)
              ? n(t)
              : (e.enter("literalAutolink"),
      ...
      rh = 48
    for (; rh < 123;)
      ((rd[rh] = rp), 58 == ++rh ? (rh = 65) : 91 === rh && (rh = 97))
    function rm(e) {
      return (
        null === e ||
        40 === e ||
    ...
    function rx(e) {
      return 43 === e || 45 === e || 46 === e || 95 === e || eb(e)
    }
    function rk(e) {
      let t = e.length,
        n = !1
    ...
    function rb(e, t, n) {
      ...
      return function (l) {
        ...
        let a = tr(i.sliceSerialize({ start: r.end, end: i.now() }))
        return 94 === a.codePointAt(0) && o.includes(a.slice(1))
    ...
    function rS(e, t, n) {
      ...
      function u(a) {
        if (o > 999 || (93 === a && !r) || null === a || 91 === a || eD(a))
          return n(a)
        if (93 === a) {
          e.exit("chunkString")
          let r = e.exit("gfmFootnoteCallString")
          return l.includes(tr(i.sliceSerialize(r)))
            ? (e.enter("gfmFootnoteCallLabelMarker"),
              e.consume(a),
              e.exit("gfmFootnoteCallLabelMarker"),
        ...
        return (eD(a) || (r = !0), o++, e.consume(a), 92 === a ? s : u)
      }
      function s(t) {
    ...
    function rC(e, t, n) {
      ...
      function s(t) {
        if (a > 999 || (93 === t && !i) || null === t || 91 === t || eD(t))
          return n(t)
        if (93 === t) {
          e.exit("chunkString")
          let n = e.exit("gfmFootnoteDefinitionLabelString")
          return (
            (r = tr(l.sliceSerialize(n))),
            e.enter("gfmFootnoteDefinitionLabelMarker"),
            e.consume(t),
            e.exit("gfmFootnoteDefinitionLabelMarker"),
        ...
        return (eD(t) || (i = !0), a++, e.consume(t), 92 === t ? c : s)
      }
      function c(t) {
      ...
      function f(t) {
        return 58 === t
          ? (e.enter("definitionMarker"),
            ...
            eF(e, p, "gfmFootnoteDefinitionWhitespace"))
          : n(t)
      }
      function p(e) {
        return t(e)
    ...
    function rE(e, t, n) {
      return e.check(ej, t, e.attempt(rv, t, n))
    }
    function rA(e) {
    ...
    function rD(e, t, n) {
      ...
      return function (e) {
        ...
        let r = t > -1 ? i.events[t][1].type : null,
          l = "tableHead" === r || "tableRow" === r ? x : a
        return l === x && i.parser.lazy[i.now().line] ? n(e) : l(e)
      }
      function a(t) {
        var n
        return (
      ...
      function f(t) {
        return ((i.interrupt = !1), i.parser.lazy[i.now().line])
          ? n(t)
          : (e.enter("tableDelimiterRow"), (r = !1), eL(t))
            ? eF(
                e,
                p,
                "linePrefix",
      ...
      function d(t) {
        return eL(t) ? eF(e, h, "whitespace")(t) : h(t)
      }
      function h(t) {
        return 58 === t
          ? ((o += 1),
      ...
      function g(t) {
        return eL(t) ? eF(e, y, "whitespace")(t) : y(t)
      }
      function y(i) {
        if (124 === i) return p(i)
        if (null === i || eT(i))
    ...
    function rL(e, t) {
        ...
        "enter" === d[0]
            ...
            : "tableRow" === h.type || "tableDelimiterRow" === h.type
              ? ((o = !0),
                ...
                c &&
                  ...
                  p.add(l, 0, [["enter", r, t]])),
                (a = "tableDelimiterRow" === h.type ? 2 : r ? 3 : 1))
              : a &&
                  ("data" === h.type ||
          ...
          : "tableHead" === h.type
            ...
            : "tableRow" === h.type || "tableDelimiterRow" === h.type
              ? ((f = l),
                0 !== u[1]
                  ? ((s[0] = s[1]), (i = rP(p, t, u, a, l, i)))
                  : 0 !== s[1] && (i = rP(p, t, s, a, l, i)),
                (a = 0))
              : a &&
                ("data" === h.type ||
                  "tableDelimiterMarker" === h.type ||
      ...
      for (
        0 !== f && rI(p, t, f, n, r), p.consume(t.events), l = -1;
        ++l < t.events.length;
      ) {
        let e = t.events[l]
        "enter" === e[0] &&
    ...
    function rP(e, t, n, r, i, l) {
      0 !== n[0] &&
        ((l.end = Object.assign({}, rM(t.events, n[0]))),
        e.add(n[0], 0, [["exit", l, t]]))
      let o = rM(t.events, n[1])
      if (
        ((l = {
          type:
      ...
      return (
        void 0 !== i &&
          ((l.end = Object.assign({}, rM(t.events, i))),
          e.add(i, 0, [["exit", l, t]]),
          (l = void 0)),
        l
      )
    ...
    function rR(e) {
      let t,
        ...
        a = l.fromMarkdownExtensions || (l.fromMarkdownExtensions = []),
        u = l.toMarkdownExtensions || (l.toMarkdownExtensions = [])
      ;(o.push(
        ek([
          { text: rd },
          {
            ...
            text: {
              91: { name: "gfmFootnoteCall", tokenize: rS },
              93: {
                ...
                return 126 === i &&
                  ...
                  : (e.enter("strikethroughSequenceTemporary"),
                    (function l(a) {
                      let u = eX(i)
                      if (126 === a)
                        return o > 1 ? r(a) : (e.consume(a), o++, l)
                      if (o < 2 && !t) return r(a)
                ...
                if (
                  ...
                  for (; r--;)
                    if (
                      ...
                      ;(a && eg(o, o.length, 0, eJ(a, e.slice(r + 1, n), t)),
                        eg(o, o.length, 0, [
                          ["exit", l, t],
                          ["enter", e[n][1], t],
                          ["exit", e[n][1], t],
          ...
          { flow: { null: { name: "table", tokenize: rD, resolveAll: rL } } },
          { text: { 91: rF } },
        ])
      ),
        a.push([
          {
            ...
            enter: {
              literalAutolink: nP,
              literalAutolinkEmail: nI,
              literalAutolinkHttp: nI,
              literalAutolinkWww: nI,
            },
            exit: {
              literalAutolink: nO,
              literalAutolinkEmail: nz,
              literalAutolinkHttp: nM,
              literalAutolinkWww: nF,
            },
          },
          {
            enter: {
              ...
              gfmFootnoteDefinition: nV,
            },
            exit: {
              gfmFootnoteCallString: nq,
              gfmFootnoteCall: nW,
          ...
          },
          {
            ...
            enter: { strikethrough: nY },
            exit: { strikethrough: nG },
          },
          {
            enter: { table: n9, tableData: n8, tableHeader: n8, tableRow: n6 },
            exit: {
              codeText: re,
              table: n5,
              tableData: n7,
          ...
          {
            exit: {
              taskListCheckValueChecked: rn,
              taskListCheckValueUnchecked: rn,
              paragraph: rr,
            },
          },
        ]),
        u.push({
          extensions: [
            ...
            i && i.firstLineBlank && (r = !0),
            {
              handlers: {
                footnoteDefinition: function (e, t, n, i) {
                  let l = n.createTracker(i),
                    o = l.move("[^"),
                    a = n.enter("footnoteDefinition"),
                    u = n.enter("label")
                  return (
                    (o += l.move(
                      n.safe(n.associationId(e), { before: o, after: "]" })
                    )),
                    u(),
                    (o += l.move("]:")),
                    e.children &&
            ...
            {
              unsafe: [
                { character: "~", inConstruct: "phrasing", notInConstruct: nJ },
              ],
              handlers: { delete: n1 },
            },
            (function (e) {
              ...
              function o(e, t, n, r) {
                let i = n.enter("tableCell"),
                  o = n.enter("phrasing"),
                  a = n.containerPhrasing(e, { ...r, before: l, after: l })
                return (o(), i(), a)
              }
              function a(e, t) {
                return (function (e, t) {
                  ...
                  for (; ++c < e.length;) {
                    ...
                    for (
                      ...
                      var f
                      let o = null == (f = e[c][l]) ? "" : String(f)
                      if (!1 !== n.alignDelimiters) {
                        let e = i(o)
                        ;((r[l] = e),
                          (void 0 === u[l] || e > u[l]) && (u[l] = e))
                      }
                      t.push(o)
                    }
                    ;((o[c] = t), (a[c] = r))
                  ...
                  for (; ++p < s;) {
                    ...
                    let i =
                        !1 === n.alignDelimiters
                          ? 1
                          : Math.max(1, u[p] - t.length - r.length),
                      o = t + "-".repeat(i) + r
                    ;(!1 !== n.alignDelimiters &&
                      ((i = t.length + i + r.length) > u[p] && (u[p] = i),
                      (h[p] = i)),
                      (d[p] = o))
                  }
                  ;(o.splice(1, 0, d), a.splice(1, 0, h), (c = -1))
                  let m = []
                  for (; ++c < o.length;) {
                    let e = o[c],
                      t = a[c]
            ...
            })(i),
            {
              ...
              handlers: { listItem: ri },
            },
          ],
        }))
    }
    function rj({ content: e }) {
      return (0, t.jsx)("div", {
        className: "prose prose-neutral dark:prose-invert max-w-none",
        children: (0, t.jsx)(nE, { remarkPlugins: [rR], children: e }),
      })
    }
    e.s(["MarkdownView", () => rj], 62038)
  },
  66765,
  (e, t, n) => {
    "use strict"
  ...
  (e) => {
    ...
    var n,
      ...
      i = e.i(57090),
      l = e.i(66765)
    let o = (0, l.createServerReference)(
    ...
    let f =
        ...
        ((t = (0, a.forwardRef)(({ className: e, ...t }, i) =>
          (0, a.createElement)(c.default, {
            ref: i,
            iconNode: r,
            className: (0, u.mergeClasses)(
              `lucide-${s(n)
        ...
        t),
      p = { owner: "擁有者", shared: "分享", public: "公開" },
      d = {
        owner: "bg-primary/10 text-primary",
        shared: "bg-blue-500/10 text-blue-700 dark:text-blue-400",
        public: "bg-muted text-muted-foreground",
      }
    function h({ comments: e, ownerMode: t, docId: n }) {
      let r = e.filter((e) => "open" === e.status),
        l = e.filter((e) => "resolved" === e.status)
      return (0, i.jsxs)("ul", {
        ...
        children: [
                  ...
                  (0, i.jsxs)("div", {
                    ...
                    children: [
                      (0, i.jsx)("span", {
                        ...
                        children: e.authorEmail,
                      }),
                      (0, i.jsx)("span", {
                        className: `rounded-full px-2 py-0.5 text-xs font-medium ${d[e.liveTrust] ?? ""}`,
                        children: p[e.liveTrust],
                      }),
                      "outdated" === e.reanchoredStatus &&
                        (0, i.jsx)("span", {
                          className:
                      ...
                      (0, i.jsx)("span", {
                        ...
                        children: new Date(e.createdAt).toLocaleString("zh-TW"),
                      }),
                    ],
                  }),
                  (0, i.jsx)("p", {
          ...
          l.length > 0 &&
            (0, i.jsxs)("li", {
              ...
              children: ["另有 ", l.length, " 則已解決的留言。"],
            }),
        ],
      })
    }
    e.s(["CommentList", () => h], 52507)
  },
  71460,
  (e) => {
    "use strict"
    ...
    function l({ docId: e }) {
      ...
      return (0, t.jsxs)("form", {
        ...
        children: [
          (0, t.jsx)("input", { type: "hidden", name: "docId", value: e }),
          (0, t.jsx)("textarea", {
            name: "body",
            required: !0,
            minLength: 1,
  ...
  (e) => {
    ...
    function o({ docId: e, visibility: r }) {
      let [o, a] = (0, n.useState)(r),
        [u, s] = (0, n.useState)(""),
        [c, f] = (0, n.useState)(!1)
      async function p(t) {
        ...
        ;(a(n), f(!0))
        let r = new FormData()
        ;(r.set("docId", e), r.set("visibility", n), await i(r), f(!1))
      }
      async function d(t) {
          ...
          (0, t.jsxs)("div", {
            ...
            children: [
              ...
              (0, t.jsxs)("select", {
                ...
                children: [
                  (0, t.jsx)("option", { value: "private", children: "私人" }),
                  (0, t.jsx)("option", { value: "shared", children: "分享" }),
                  (0, t.jsx)("option", { value: "public", children: "公開" }),
                ],
              }),
              c &&
                (0, t.jsx)("span", {
