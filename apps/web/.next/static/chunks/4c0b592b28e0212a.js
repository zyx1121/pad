;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function m(t) {
      ...
      let D = N ? o && "object" == typeof o && o.ref : A,
        K = a.default.useCallback(
          (e) => (
            null !== U &&
              (v.current = (0, p.mountLinkInstance)(e, B, U, I, $, m)),
            () => {
              ;(v.current &&
      ...
      return (
        (0, f.isAbsoluteUrl)(F)
          ? (W.href = F)
          : (N && !j && ("a" !== o.type || "href" in o.props)) ||
            (W.href = (0, d.addBasePath)(F)),
        (u = N
