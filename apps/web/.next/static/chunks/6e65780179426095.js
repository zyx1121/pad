;(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    function f(e, t) {
      if (e.dev)
        switch (t.type) {
          ...
          case "request":
            var r
            return null == (r = t.cookies.get(i.NEXT_HMR_REFRESH_HASH_COOKIE))
              ? void 0
              : r.value
        }
    }
  ...
  (e, t, r) => {
    ...
    ;(Object.defineProperty(r, "__esModule", { value: !0 }),
      ...
      e.r(960).HTTP_ERROR_FALLBACK_ERROR_CODE,
      ("function" == typeof r.default ||
        ("object" == typeof r.default && null !== r.default)) &&
        void 0 === r.default.__esModule &&
        (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let u = (n = e.r(34720)) && n.__esModule ? n : { default: n },
      s = e.r(51997),
      c = e.r(89174),
      d = e.r(63747),
      l = e.r(43831),
    ...
    function j({ reason: e, route: t }) {
      ...
      D(t, e, r && "prerender-ppr" === r.type ? r.dynamicTracking : null)
    }
    function D(e, t, r) {
      ;((function () {
        if (!b)
...
${t}`
      ...
      return (
        e.abort(
          Object.defineProperty(
            new m.BailoutToCSRError("Render in Browser"),
            "__NEXT_ERROR_CODE",
      ...
      switch (e.type) {
        ...
        case "prerender-runtime":
          ...
          if (e.cacheSignal)
            ...
            r
              ? r.then(() => (0, h.scheduleOnNextTick)(() => t.abort()))
              : (0, h.scheduleOnNextTick)(() => t.abort())
          }
          return t.signal
        case "prerender-client":
        case "prerender-ppr":
        ...
        get: function () {
          return function e(t) {
            if (
              ...
              (0, u.isPrerenderInterruptedError)(t)
            )
              throw t
            t instanceof Error && "cause" in t && e(t.cause)
          }
  ...
  (e, t, r) => {
    ...
    let n =
      "u" < typeof window
        ? e.r(22860).unstable_rethrow
        : e.r(60879).unstable_rethrow
    ;("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let o = e.r(75244)._(e.r(34720)),
      ...
      d = e.r(55387),
      l = e.r(19781),
      f = "u" < typeof window ? e.r(2312).useDynamicRouteParams : void 0,
      p = "u" < typeof window ? e.r(2312).useDynamicSearchParams : void 0
    function h() {
      p?.("useSearchParams()")
    ...
    function _(e = "children") {
      ;(f?.("useSelectedLayoutSegment()"),
        (0, o.useContext)(u.NavigationPromisesContext))
      let t = g(e)
