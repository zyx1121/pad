module.exports = [
  ...
  (e) => {
    ...
    class e4 extends eL.QueryCreator {
      #n
      constructor(e) {
        let t, n
        if (
      ...
      transaction() {
        return new e6({ ...this.#n })
      }
      startTransaction() {
        return new e7({ ...this.#n })
      }
      connection() {
    ...
    class e6 {
      ...
      setAccessMode(e) {
        return new e6({ ...this.#n, accessMode: e })
      }
      setIsolationLevel(e) {
        return new e6({ ...this.#n, isolationLevel: e })
      }
      async execute(e) {
    ...
    class e7 {
      ...
      setAccessMode(e) {
        return new e7({ ...this.#n, accessMode: e })
      }
      setIsolationLevel(e) {
        return new e7({ ...this.#n, isolationLevel: e })
      }
      async execute() {
        let { isolationLevel: e, accessMode: t, ...r } = this.#n,
          n = { isolationLevel: e, accessMode: t }
        eH(n)
        let o = await (0, e8.provideControlledConnection)(this.#n.executor)
        return (
    ...
    class e3 extends e9 {
      ...
      withPlugin(e) {
        return new e3({ ...this.#n, executor: this.#n.executor.withPlugin(e) })
      }
      withoutPlugins() {
        return new e3({
          ...this.#n,
...
${r}`
    ...
    function t4(e) {
      if (!e) return null
      if ("dialect" in e) return t4(e.dialect)
    ...
    let t9 = async (t) => {
      ...
      if ("dialect" in n)
        return {
          kysely: new e4({ dialect: n.dialect }),
          databaseType: n.type,
          transaction: n.transaction,
        }
      let o = t4(n)
      if (
        ...
        let { BunSqliteDialect: t } = await e.A(68926)
        r = new t({ database: n })
      }
      if ("createSession" in n) {
        ...
        if (t && n instanceof t) {
          let { NodeSqliteDialect: t } = await e.A(64154)
          r = new t({ database: n })
        }
      }
      if ("batch" in n && "exec" in n && "prepare" in n) {
        let { D1SqliteDialect: t } = await e.A(23258)
        r = new t({ database: n })
      }
      return {
        kysely: r ? new e4({ dialect: r }) : null,
        databaseType: o,
        transaction: void 0,
      }
    }
...
//# sourceMappingURL=e426d_%40better-auth_kysely-adapter_dist_index_mjs_73350d15._.js.map
